...
<?php 
if ($this->session->userdata('user') !== 'pengantar'){
		redirect('pegawai');
	}
?>
<!DOCTYPE html>
			...
			<div class="row" style="width: 100%;height: 89%; text-align: center;">
				<div class="col" style="height: 100%;">
					<div class="row" style="margin-top: 3%">
						...
						<div class="col-4">
							<label style="width: 100%; font-size: 20px; color: #55EFC4;">Pengantaran</label>
						</div>
						<div class="col-4">
					...
					<table id="table" class="display" style="background-color: #f2f2f2" align="center">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<form method="post" action="<?php base_url()?>pengantar/validasiPengantaran">
